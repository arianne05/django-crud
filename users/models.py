#this file allow the creation of new table in a database
#for every new created table it need to mrun the makemigration in terminal
...
class User(models.Model):
    ...
    #for image uploading and displaying
    user_image = models.ImageField(upload_to=image_path, default='profile_pic/image.jpg')
    def image_tag(self): #display in admin django dashboard as img not image name
